#!/usr/bin/env python3
"""
Fixed test suite for MathLedger v0.5 UI implementation.
Properly mocks database connections to avoid hanging.
"""
...
# Mock psycopg before importing the app
...
class TestV05Fixed:
    """Test v0.5 functionality with proper mocking."""
