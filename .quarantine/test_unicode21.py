...
# Test with actual Unicode characters
s17 = 'p → (q ∧ r)'
print('Original17:', repr(s17))
print('Chars17:', [ord(c) for c in s17])
print('ASCII17:', repr(_to_ascii(s17)))

# Test full normalization
try:
    result17 = normalize(s17)
    print('Normalized17:', repr(result17))
except Exception as e:
    print('Normalize error17:', e)
