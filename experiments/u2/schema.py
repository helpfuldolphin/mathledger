...
class SessionStartEvent(BaseModel):
    ...
    event_type: Literal["session_start"] = EVENT_SESSION_START
    run_id: str
    slice_name: str
    mode: str
    schema_version: str
...
class SessionEndEvent(BaseModel):
    ...
    event_type: Literal["session_end"] = EVENT_SESSION_END
    run_id: str
    slice_name: str
    mode: str
    schema_version: str
...
class CycleBeginEvent(BaseModel):
    ...
    event_type: Literal["cycle_begin"] = EVENT_CYCLE_BEGIN
    cycle_index: int
    timestamp_ms: float
...
class CycleEndEvent(BaseModel):
    ...
    event_type: Literal["cycle_end"] = EVENT_CYCLE_END
    cycle_index: int
    timestamp_ms: float
    duration_ms: float
...
class CycleTelemetryEvent(BaseModel):
    ...
    event_type: Literal["cycle_telemetry"] = EVENT_CYCLE_TELEMETRY
    cycle_index: int
...
class PolicyWeightUpdateEvent(BaseModel):
    ...
    event_type: Literal["policy_weight_update"] = EVENT_POLICY_WEIGHT_UPDATE
    cycle_index: int
    item: str
    old_weight: float
    new_weight: float
...
class SnapshotSavedEvent(BaseModel):
    ...
    event_type: Literal["snapshot_saved"] = EVENT_SNAPSHOT_SAVED
    cycle_index: int
    snapshot_path: str
    snapshot_hash: str
...
class EvalLintEvent(BaseModel):
    ...
    event_type: Literal["eval_lint"] = EVENT_EVAL_LINT
    cycle_index: int
    expression: str
    is_safe: bool
