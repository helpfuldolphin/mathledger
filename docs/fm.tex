...
Phase II code paths use a \textbf{restricted AST arithmetic evaluator} for processing numeric expressions in experiment configurations and metrics. This evaluator is implemented in \texttt{experiments/u2\_safe\_eval.py}.
...
See \texttt{experiments/u2\_safe\_eval.py} for the complete implementation. The module provides:
